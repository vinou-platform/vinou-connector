...
class CacheExpertiseTaskAdditionalFieldProvider implements AdditionalFieldProviderInterface {
	...
	public function getAdditionalFields(array &$taskInfo, $task, SchedulerModuleController $parentObject) {
		...
		foreach ($fieldKeys as $fieldId) {
			...
			$additionalFields[$fieldId] = array(
				'code' => $html,
				'label' => 'LLL:EXT:'. Helper::getExtKey() . '/Resources/Private/Language/locallang.xlf:tasks.cacheexpertise.field.' . $fieldId,
