 ...
 */
class CacheImagesTaskAdditionalFieldProvider implements \TYPO3\CMS\Scheduler\AdditionalFieldProviderInterface
{
    ...
    public function getAdditionalFields(array &$taskInfo, $task, \TYPO3\CMS\Scheduler\Controller\SchedulerModuleController $parentObject)
    {
        ...
        foreach ($fieldKeys as $fieldId) {
            ...
            $additionalFields[$fieldId] = array(
                'code' => $html,
                'label' => 'LLL:EXT:'.$extKey.'/Resources/Private/Language/locallang.xlf:tasks.cacheimages.field.'.$fieldId,
